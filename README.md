...
<title>Close the Year Gracefully</title>
<style>
  body {
    margin: 0;
...
<div class="page active" id="intro">
  <div class="emoji">🌙</div>
  <h1>Close the Year Gracefully</h1>
...
<div class="page" id="bad">
  <div class="emoji">📝</div>
  <h1>What You're Ready to Let Go Of</h1>
...
<div class="page" id="affirm">
  ...
  <div class="affirmation">I am allowed to start again.</div>
